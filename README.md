Este proyecto es una aplicación web de E-Wallet (billetera electrónica) llamada "Alke Wallet". A continuación se detallan las características implementadas:
